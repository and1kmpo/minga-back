...
const schema = joi.object({
    title: joi.string().required().min(3).messages({
            ...
            'string.min': 'Title must have a minimum of 3 characters.!'
        }),
    description: joi.string().required().min(10).messages({
            'any.required': 'Description is required!',
            'string.base': 'Description is required!',
            'string.empty': 'Description is required!',
            'string.min': 'The description must have a minimum of 10 characters!'
        }),
    cover_photo: joi.string().required().uri().min(10).messages({
            'any.required': 'Cover Photo is required!',
            'string.base': 'Cover Photo is required!',
            'string.empty': 'Cover Photo is required!',
            'string.min': 'Cover Photo must have a minimum of 10 characters.!',
